...
public class TreeSetTestDriver {
    ...
    public TreeSetTestDriver(experiment.util.TreeSet arg0) {
    	init();

        this.classUnderTest = new experiment.util.TreeSet(arg0);
        writeInternalState("CTOR", new String[]{arg0.toString()});
    } 
 
    public TreeSetTestDriver(experiment.util.Comparator arg0) {
    	init();
    ...
    public TreeSetTestDriver() {
    	init();

        this.classUnderTest = new experiment.util.TreeSet();
        writeInternalState("CTOR", new String[]{});
    } 
 
    public TreeSetTestDriver(experiment.util.Collection arg0) {
    	init();
    ...
    public java.lang.Object last() {
	    try {
          return getClassUnderTest().last();

		} finally {
			writeInternalState("last", new String[]{getStringRepresentation()});
		}
    }
    ...
    public java.lang.Object first() {
	    try {
          return getClassUnderTest().first();

		} finally {
			writeInternalState("first", new String[]{getStringRepresentation()});
		}
    }
    ...
    public java.lang.Object getMatch(java.lang.Object arg0) {
	    try {
          return getClassUnderTest().getMatch(arg0);

		} finally {
			writeInternalState("getMatch", new String[]{getStringRepresentation(arg0.toString())});
		}
    }
    ...
    public static boolean matchInternalStateSnapshot() {
       ...
       CsvComparisonOptions options = CsvComparisonOptions
        .builder()
        .setColumns("id", "last","size","first","isEmpty","toArray", "calledMethod","arguments")
	...
	private void startInternalStateRecording(String testId) {
    	...
    	//write header line    
    	write("id,testId,instanceId,last,size,first,isEmpty,toArray,calledMethod,arguments"+"\n");
	}
    ...
    private String getInternalState(String methodName, String[] parametersAsString) {
    	...
    	try {
	   		state.add(getStringRepresentation(getClassUnderTest().last().toString()));
        } catch (Exception e) {
        	//e.printStackTrace();
        	state.add("EXC");
        }
    	...
    	try {
	   		state.add(getStringRepresentation(getClassUnderTest().first().toString()));
        } catch (Exception e) {
        	//e.printStackTrace();
        	state.add("EXC");
        }
