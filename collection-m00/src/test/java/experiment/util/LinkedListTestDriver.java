...
public class LinkedListTestDriver {
    ...
    public LinkedListTestDriver(experiment.util.Collection arg0) {
    	init();

        this.classUnderTest = new experiment.util.LinkedList(arg0);
        writeInternalState("CTOR", new String[]{arg0.toString()});
    } 
 
    public LinkedListTestDriver() {
    	init();

        this.classUnderTest = new experiment.util.LinkedList();
    ...
    public void add(int arg0, java.lang.Object arg1) {
	    try {
          getClassUnderTest().add(arg0,arg1);
			...
			writeInternalState("add", new String[]{getStringRepresentation(java.lang.Integer.toString(arg0),arg1.toString())});
		}
    }
    ...
    public void addLast(java.lang.Object arg0) {
	    try {
          getClassUnderTest().addLast(arg0);
			...
			writeInternalState("addLast", new String[]{getStringRepresentation(arg0.toString())});
		}
    }
    ...
    public void addFirst(java.lang.Object arg0) {
	    try {
          getClassUnderTest().addFirst(arg0);
			...
			writeInternalState("addFirst", new String[]{getStringRepresentation(arg0.toString())});
		}
    }
    ...
    public java.lang.Object removeFirst() {
	    try {
          return getClassUnderTest().removeFirst();
			...
			writeInternalState("removeFirst", new String[]{getStringRepresentation()});
		}
    }
    ...
    public java.lang.Object removeLast() {
	    try {
          return getClassUnderTest().removeLast();
			...
			writeInternalState("removeLast", new String[]{getStringRepresentation()});
		}
    }

    public java.lang.Object getFirst() {
	    try {
          return getClassUnderTest().getFirst();

		} finally {
			writeInternalState("getFirst", new String[]{getStringRepresentation()});
		}
    }

    public java.lang.Object getLast() {
	    try {
          return getClassUnderTest().getLast();

		} finally {
			writeInternalState("getLast", new String[]{getStringRepresentation()});
		}
    }
    ...
    public static boolean matchInternalStateSnapshot() {
       ...
       CsvComparisonOptions options = CsvComparisonOptions
        .builder()
        .setColumns("id", "size","iterator","getFirst","getLast","isEmpty","toArray", "calledMethod","arguments")
	...
	private void startInternalStateRecording(String testId) {
    	...
    	//write header line    
    	write("id,testId,instanceId,size,iterator,getFirst,getLast,isEmpty,toArray,calledMethod,arguments"+"\n");
	}
    ...
    private String getInternalState(String methodName, String[] parametersAsString) {
    	...
    	try {
	   		state.add(getStringRepresentation(getClassUnderTest().getFirst().toString()));
        } catch (Exception e) {
        	//e.printStackTrace();
        	state.add("EXC");
        }
    	try {
	   		state.add(getStringRepresentation(getClassUnderTest().getLast().toString()));
        } catch (Exception e) {
        	//e.printStackTrace();
        	state.add("EXC");
        }
