...
/**
 * Generated class that is intended to be used as test driver for class {@link HashMap}.
...
public class HashMapTestDriver {
    ...
    //class under test
    private experiment.util.HashMap classUnderTest;
    ...
    public HashMapTestDriver() {
    	init();

        this.classUnderTest = new experiment.util.HashMap();
        writeInternalState("CTOR", new String[]{});
    } 
 
    public HashMapTestDriver(experiment.util.Map arg0) {
    	init();

        this.classUnderTest = new experiment.util.HashMap(arg0);
    ...
    protected experiment.util.HashMap getClassUnderTest() {
