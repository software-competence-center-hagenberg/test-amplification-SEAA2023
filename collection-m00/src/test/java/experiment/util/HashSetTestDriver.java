...
public class HashSetTestDriver {
    ...
    public HashSetTestDriver() {
    	init();

        this.classUnderTest = new experiment.util.HashSet();
        writeInternalState("CTOR", new String[]{});
    } 
 
    public HashSetTestDriver(experiment.util.Collection arg0) {
    	init();

        this.classUnderTest = new experiment.util.HashSet(arg0);
